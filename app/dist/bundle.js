...
/******/ 	var hotCurrentHash = "a65f2333eef854fbda5f"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_locations__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__viewModels_neighborhood__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_googlemaps__ = __webpack_require__(23);
...
var vm = new __WEBPACK_IMPORTED_MODULE_3__viewModels_neighborhood__["a" /* default */](__WEBPACK_IMPORTED_MODULE_2__models_locations__["a" /* default */]);
window.initMap = new __WEBPACK_IMPORTED_MODULE_4__helpers_googlemaps__["a" /* default */](vm.locationList, vm).createInitMap();
__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.applyBindings(vm);

__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).ready(function () {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#map").css("height", __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).height());
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_knockout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_library_web_timers__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_library_web_timers___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_core_js_library_web_timers__);
...
function viewModel(locations) {
     ...
     ***************************/
    self.locationList = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observableArray(cloneObject(locations));

    /***************************
     *  Property to store the filter
     ***************************/
    self.filter = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable('');
    ...
    self.filterLocations = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.computed({
        read: function read() {},
        write: function write(filterValue) {
            if (!filterValue || filterValue == undefined) {
                self.locationList.removeAll();
                __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.utils.arrayPushAll(self.locationList, locations);
            } else {
    ...
    self.filter.subscribe(function (searchTerm) {
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (googleMapsApi);
...
function googleMapsApi(locations, viewModel) {
    ...
    var Api = {
        ...
        markers: null,
        infoWindow: null,
        createInitMap: function createInitMap() {
            return function () {
        ...
        changeLocation: function changeLocation(location) {
            ...
            var currentMarker = InternalApi.getMarkerByLocation(location.location);
    ...
    var InternalApi = {
        initializeMarkers: function initializeMarkers() {
         ...
         *******************************/
        createEachMarker: function createEachMarker(location, index) {
        ...
        deleteAllMarkers: function deleteAllMarkers() {
            if (Api.markers) {
                Api.markers.forEach(function (marker) {
                    marker.setMap(null);
                });
         ...
         *******************************/
        populateInfoWindow: function populateInfoWindow(marker) {
            if (Api.infoWindow.marker != marker) {
                var getStreetView = function getStreetView(data, status) {
                    if (status == google.maps.StreetViewStatus.OK) {
                        ...
                        Api.infoWindow.setContent('<div>' + marker.title + '</div>' + '<div>No Street View Found</div>');
                    }
                };
        ...
        createInfoWindowInstance: function createInfoWindowInstance() {
            Api.infoWindow = new google.maps.InfoWindow();
        },
        createMapInstance: function createMapInstance() {
        ...
        getMarkerByLocation: function getMarkerByLocation(location) {
            var latLng = new google.maps.LatLng(location.lat, location.lng);
            var markersFiltered = Api.markers.filter(function (marker) {
